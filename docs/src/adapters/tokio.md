...
[dependencies]
wasm-smtp = "0.18"
wasm-smtp-tokio = "0.18"

# Distroless container with bundled Mozilla roots, aws-lc-rs:
# wasm-smtp-tokio = { version = "0.18", default-features = false, features = ["webpki-roots", "aws-lc-rs"] }

# Fast-rebuild CI with system trust, ring:
# wasm-smtp-tokio = { version = "0.18", default-features = false, features = ["native-roots", "ring"] }

# Most minimal — bundled roots, ring (smallest dep tree, fastest build):
# wasm-smtp-tokio = { version = "0.18", default-features = false, features = ["webpki-roots", "ring"] }
```
